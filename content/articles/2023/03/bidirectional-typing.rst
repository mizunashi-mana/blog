...
.. [#practical-examples-of-bidir-typing] 元々 Scala を事例に出してたが、Scala は双方向型システムによるアルゴリズムは型検査に使ってなさそうだったので、訂正した。申し訳ない。
